...
class OfferWidgetFinishedOrder extends StatelessWidget {
  const OfferWidgetFinishedOrder({super.key,  this.isFinished = false});
      ...
      child: Column(
        children: [
          ...
          CustomElevatedButton.text(onPressed: () {
            isFinished ? null : Routes.orderDetails.moveTo;
          }, text: "التفاصيل"),
        ],
      ),
    );
